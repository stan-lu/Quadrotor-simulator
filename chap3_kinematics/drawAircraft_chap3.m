...
function drawAircraft_chap3(uu,P)
...
%     field_view_handle = drawFieldOfView(px,py,pz,Vert_field_view,[]);
    % at every other time step, redraw base and rod
else
    drawVehicleBody(Vertices,Faces,facecolors,...
        px,py,pz,phi,theta,psi,...
        vehicle_handle);
%     drawFieldOfView(px,py,pz,Vert_field_view,field_view_handle);
...
% drawFieldOfView
%=======================================================================
function handle = drawFieldOfView(x,y,z,Vert,handle)
